...
var DialogRef = class {
  ...
  closed = new import_rxjs4.Subject();
...
var Dialog = class _Dialog {
  ...
  _afterAllClosedAtThisLevel = new import_rxjs4.Subject();
  _afterOpenedAtThisLevel = new import_rxjs4.Subject();
   ...
   */
  afterAllClosed = (0, import_rxjs4.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators3.startWith)(void 0)));
  constructor() {
  }
...
var MatDialogRef = class {
  ...
  _afterOpened = new import_rxjs5.Subject();
  /** Subject for notifying the user that the dialog has started closing. */
  _beforeClosed = new import_rxjs5.Subject();
  ...
  constructor(_ref, config, _containerInstance) {
    ...
    _containerInstance._animationStateChanged.pipe((0, import_operators4.filter)((event) => event.state === "opened"), (0, import_operators4.take)(1)).subscribe(() => {
      this._afterOpened.next();
      this._afterOpened.complete();
    });
    _containerInstance._animationStateChanged.pipe((0, import_operators4.filter)((event) => event.state === "closed"), (0, import_operators4.take)(1)).subscribe(() => {
  ...
  close(dialogResult) {
    ...
    this._containerInstance._animationStateChanged.pipe((0, import_operators4.filter)((event) => event.state === "closing"), (0, import_operators4.take)(1)).subscribe((event) => {
...
var MatDialog = class _MatDialog {
  ...
  _openDialogsAtThisLevel = [];
  _afterAllClosedAtThisLevel = new import_rxjs5.Subject();
  _afterOpenedAtThisLevel = new import_rxjs5.Subject();
   ...
   * Will emit on subscribe if there are no open dialogs to begin with.
   */
  afterAllClosed = (0, import_rxjs5.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators4.startWith)(void 0)));
  constructor() {
